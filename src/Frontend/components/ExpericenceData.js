const TimeLine_Element = [
  {
    ...
    data: {
      education: [
        {
          title: 'BTech in Electronics Instrumentation & Control',
          university: 'Bikaner Technical University, Bikaner',
          Duration: '(2019 - 2023)',
          description: 'Demo'
        },
        {
          title: 'AS - Science & Information',
          university: 'Board of Secondary Education Rajasthan, Ajmer',
          Duration: '(2018 - 2019)',
          description: 'Demo'
        },
        {
      ...
      softwareSkills: [
        {
          ...
          nest_data: ['ReactJS', 'HTML', 'CSS', 'JavaScript', 'TypeScript', 'Tailwind', 'Bootstrap', 'Redux']
        },
        {
          title: 'Mobile Application Developer',
          nest_data: ['React Native', 'JavaScript', 'TypeScript', 'AsyncStorage']
        },
        {
          title: 'Server Side',
          nest_data: ['Node JS', 'Rest APIs', 'ExpressJS', 'Axios', 'AWS']
        },
        {
          title: 'Databases',
          nest_data: ['MySQL', 'MongoDB', 'PostgreSQL']
        },
        {
          title: 'Development & Tools',
          nest_data: ['GitHub', 'WordPress', 'Material UI', 'Git', 'Netlify']
        }
      ],
      experience: [
        {
          ...
          description:
            <ul>
              <li> • Implemented WordPress and Wix CMS.</li>
              <li> • Reduced content management time.</li>
              <li> • Enabled clients to update their websites independently.</li>
